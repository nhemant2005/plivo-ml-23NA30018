...
def main():
    ...
    # AdamW + weight_decay=0.1 tried and regressed slightly vs plain Adam
    # (RUNLOG Run 4) — 2000 steps isn't long enough to overfit, so decay
    # just costs a little capacity instead of catching anything.
